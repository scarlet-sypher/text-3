document.addEventListener('DOMContentLoaded', function() {
    ...
    const successUserIdDiv = document.getElementById('successUserId');
    ...
    function validateForm() {
      ...
      const isCompanyValid = validateField('company', 'company-error', validateCompany, 'Please enter your company name');
    ...
    signupForm.addEventListener('submit', function(e) {
      ...
      if (validateForm()) {
        // Generate user ID
        const userId = "CB" + Date.now().toString().slice(-6);
        ...
        setTimeout(function() {
          ...
          successUserIdDiv.textContent = userId;
    ...
    document.getElementById('company').addEventListener('blur', function() {
      validateField('company', 'company-error', validateCompany, 'Please enter your company name');
    });
